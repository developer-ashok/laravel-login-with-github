...
laravel login with github easy integration
...
1. clone package [git clone https://github.com/developer-ashok/laravel-login-with-github]
2. install composer dependency [composer install]
3. php artisan serve

<a href="https://codescompanion.com/easy-integration-of-laravel-5-x-login-with-github-using-socialite">Read more..</a>.
